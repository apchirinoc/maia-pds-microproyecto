...
class Model(Base):
    ...
    f1_macro: Mapped[Decimal | None] = mapped_column(Numeric(6, 4))
    ...
    size_mb: Mapped[Decimal | None] = mapped_column(Numeric(9, 2))
    ...
    target_draft_version: Mapped[str | None] = mapped_column(Text)
